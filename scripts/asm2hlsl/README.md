...
the DX11 output hashes are pinned separately. The normal x64 Pre-CU staging workflow then
deploys these programs with the rest of the tracked loose DX11 overrides.
