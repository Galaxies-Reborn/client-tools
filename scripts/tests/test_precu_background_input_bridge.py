...
class PrecuBackgroundInputBridgeTests(unittest.TestCase):
    ...
    def test_bridge_queues_internal_input_events(self):
        for token in [
            ...
            '"QueueMelee2hLunge2", "QueueHealthShot2", "QueuePistolMeleeDefense1"',
            "QueueMelee2hLunge2 = 362",
            "Melee2hLunge2WeaponStatus = 363",
            "performBackgroundQueueTaunt(lParam)",
            'getBackgroundGeneratedCombatWeaponStatus("taunt")',
            "BIC_queueTaunt",
            "BIC_tauntWeaponStatus",
            '"QueueTaunt"',
            '"TauntWeaponStatus"',
            '"TauntWeaponStatus", "HealthShot2WeaponStatus", "PistolMeleeDefense1WeaponStatus"',
            "QueueTaunt = 364",
            ...
            '"QueuePistolMeleeDefense1"',
            '"PistolMeleeDefense1WeaponStatus"',
            ...
            '"QueueMelee1hHealthHit1"',
            '"QueueMelee1hSpinAttack2"',
            '"QueueMelee1hHealthHit2"',
            "QueueMelee1hHealthHit1 = 380",
            "QueueMelee1hSpinAttack2 = 381",
            "QueueMelee1hHealthHit2 = 382",
            'performBackgroundQueueMarksmanTier1(\n\t\t\t\t\t\t"melee1hHit3"',
            'getBackgroundGeneratedCombatWeaponStatus("melee1hHit3")',
            ...
            'performBackgroundQueueMarksmanTier1(\n\t\t\t\t\t\t"polearmArea2"',
            'getBackgroundGeneratedCombatWeaponStatus("polearmArea2")',
            "BIC_queuePolearmArea2",
            "BIC_polearmArea2WeaponStatus",
            '"QueuePolearmArea2"',
            '"PolearmArea2WeaponStatus"',
            "QueuePolearmArea2 = 391",
            "PolearmArea2WeaponStatus = 392",
            'performBackgroundQueueMarksmanTier1(\n\t\t\t\t\t\t"polearmSweep1"',
            'getBackgroundGeneratedCombatWeaponStatus("polearmSweep1")',
            ...
            'performBackgroundQueueMarksmanTier1(\n\t\t\t\t\t\t"melee2hHit3"',
            'getBackgroundGeneratedCombatWeaponStatus("melee2hHit3")',
            ...
            'performBackgroundQueueMarksmanTier1(\n\t\t\t\t\t\t"unarmedKnockdown1"',
            'getBackgroundGeneratedCombatWeaponStatus("unarmedKnockdown1")',
            ...
            'performBackgroundQueueMarksmanTier1(\n\t\t\t\t\t\t"unarmedKnockdown2"',
            'getBackgroundGeneratedCombatWeaponStatus("unarmedKnockdown2")',
            ...
            "BIC_queueMeditate",
            "performBackgroundQueueMeditate",
            '"QueueMeditate"',
            "QueueMeditate = 421",
            "BIC_queuePowerBoost",
            "BIC_queueForceOfWill",
            "performBackgroundQueuePowerBoost",
            "performBackgroundQueueForceOfWill",
            '"QueuePowerBoost"',
            '"QueueForceOfWill"',
            "QueuePowerBoost = 422",
            "QueueForceOfWill = 423",
            'performBackgroundQueueMarksmanTier1(\n\t\t\t\t\t\t"unarmedHit3"',
            'getBackgroundGeneratedCombatWeaponStatus("unarmedHit3")',
            ...
            "performBackgroundQueueFeignDeath()",
            'getBackgroundGeneratedCombatWeaponStatus("feignDeath")',
            '"QueueFeignDeath"',
