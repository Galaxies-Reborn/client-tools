...
switch ($Action) {
    ...
    { $_ -in @("QueueOverChargeShot1", "QueuePointBlankSingle1") } {
    ...
    { $_ -in @("OverChargeShot1WeaponStatus", "PointBlankSingle1WeaponStatus") } {
