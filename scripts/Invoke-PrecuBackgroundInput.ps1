...
switch ($Action) {
    ...
    { $_ -in @("QueueBodyShot1", "QueueLegShot1", "QueuePolearmLegHit1", "QueueUnarmedHeadHit1") } {
    ...
    { $_ -in @("PolearmLegHit1WeaponStatus", "UnarmedHeadHit1WeaponStatus") } {
