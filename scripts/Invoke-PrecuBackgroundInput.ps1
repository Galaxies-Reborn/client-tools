...
switch ($Action) {
    ...
    { $_ -in @("PolearmLegHit1WeaponStatus", "PolearmLegHit2WeaponStatus", "PolearmLegHit3WeaponStatus", "PolearmHit1WeaponStatus", "PolearmArea1WeaponStatus", "Melee2hSpinAttack2WeaponStatus", "UnarmedHeadHit1WeaponStatus", "PolearmSpinAttack1WeaponStatus", "Melee1hSpinAttack1WeaponStatus", "Melee2hSpinAttack1WeaponStatus", "Melee1hBodyHit1WeaponStatus", "Melee1hBodyHit2WeaponStatus", "Melee1hBodyHit3WeaponStatus", "Melee2hHeadHit1WeaponStatus", "Melee2hHeadHit2WeaponStatus", "Melee2hHeadHit3WeaponStatus", "Melee1hHit1WeaponStatus", "Melee1hHit2WeaponStatus", "Melee2hHit1WeaponStatus", "Melee2hHit2WeaponStatus", "BodyShot2WeaponStatus", "BodyShot3WeaponStatus", "HeadShot2WeaponStatus", "HeadShot3WeaponStatus") } {
