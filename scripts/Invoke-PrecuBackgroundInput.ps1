...
switch ($Action) {
    ...
    { $_ -in @("QueueOverChargeShot1", "QueuePointBlankSingle1", "QueueThreatenShot", "QueueWarningShot", "QueueAim", "QueueSuppressionFire1", "QueueRollShot", "QueueDiveShot", "QueueKipUpShot", "QueueTakeCover", "QueueFullAutoSingle1", "QueueScatterShot1", "QueueScatterShot2", "QueueLegShot2", "QueueLegShot3") } {
    ...
    { $_ -in @("OverChargeShot1WeaponStatus", "PointBlankSingle1WeaponStatus", "ThreatenShotWeaponStatus", "WarningShotWeaponStatus", "AimWeaponStatus", "SuppressionFire1WeaponStatus", "RollShotWeaponStatus", "DiveShotWeaponStatus", "KipUpShotWeaponStatus", "TakeCoverWeaponStatus", "FullAutoSingle1WeaponStatus", "ScatterShot1WeaponStatus", "ScatterShot2WeaponStatus", "LegShot2WeaponStatus", "LegShot3WeaponStatus") } {
