...
switch ($Action) {
    ...
    { $_ -in @("EquipCdefPistol", "EquipCdefCarbine", "EquipFixtureLightsaber", "EquipFixtureFallbackSword", "EquipFixturePolearm", "EquipFixtureOneHand", "EquipFixtureTwoHand", "EquipFixtureAcid", "EquipFixtureLightning") } {
