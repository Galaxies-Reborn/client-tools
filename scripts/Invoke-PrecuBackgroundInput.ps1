...
switch ($Action) {
    ...
    { $_ -in @("QueueOverChargeShot1", "QueuePointBlankSingle1", "QueueThreatenShot", "QueueWarningShot", "QueueAim", "QueueSuppressionFire1") } {
    ...
    { $_ -in @("OverChargeShot1WeaponStatus", "PointBlankSingle1WeaponStatus", "ThreatenShotWeaponStatus", "WarningShotWeaponStatus", "AimWeaponStatus", "SuppressionFire1WeaponStatus") } {
