...
switch ($Action) {
    ...
    { $_ -in @("OverChargeShot1WeaponStatus", "PointBlankSingle1WeaponStatus", "ThreatenShotWeaponStatus", "WarningShotWeaponStatus", "AimWeaponStatus", "SuppressionFire1WeaponStatus", "RollShotWeaponStatus", "DiveShotWeaponStatus", "KipUpShotWeaponStatus", "TakeCoverWeaponStatus", "FullAutoSingle1WeaponStatus") } {
