...
switch ($Action) {
    ...
    { $_ -in @("QueueOverChargeShot1", "QueuePointBlankSingle1", "QueueThreatenShot", "QueueWarningShot", "QueueAim", "QueueSuppressionFire1", "QueueRollShot", "QueueDiveShot", "QueueKipUpShot", "QueueTakeCover", "QueueFullAutoSingle1", "QueueScatterShot1", "QueueScatterShot2", "QueueLegShot2", "QueueLegShot3", "QueueFullAutoSingle2") } {
