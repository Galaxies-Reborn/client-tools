...
switch ($Action) {
    ...
    { $_ -in @("QueueBodyShot1", "QueueLegShot1", "QueuePolearmLegHit1", "QueueUnarmedHeadHit1", "QueuePolearmSpinAttack1", "QueueMelee1hSpinAttack1", "QueueMelee2hSpinAttack1", "QueueMelee1hBodyHit1", "QueueBodyShot2", "QueueBodyShot3", "QueueHeadShot3") } {
    ...
    { $_ -in @("PolearmLegHit1WeaponStatus", "UnarmedHeadHit1WeaponStatus", "PolearmSpinAttack1WeaponStatus", "Melee1hSpinAttack1WeaponStatus", "Melee2hSpinAttack1WeaponStatus", "Melee1hBodyHit1WeaponStatus", "BodyShot2WeaponStatus", "BodyShot3WeaponStatus", "HeadShot2WeaponStatus", "HeadShot3WeaponStatus") } {
