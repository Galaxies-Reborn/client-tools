...
switch ($Action) {
    ...
    { $_ -in @("QueueOverChargeShot1", "QueuePointBlankSingle1", "QueueThreatenShot", "QueueWarningShot") } {
    ...
    { $_ -in @("OverChargeShot1WeaponStatus", "PointBlankSingle1WeaponStatus", "ThreatenShotWeaponStatus", "WarningShotWeaponStatus") } {
