...
// NPCs keep moving and the frame rate never changes. NPCs are unaffected because they come through
// RemoteCreatureController, which never takes the warp path.
//
...
namespace GameSimulationSchedule
{
	...
	// behaviour of a single step of real elapsed time.
